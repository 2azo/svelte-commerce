...
export * from './website'
export const adminUrl = 'http://localhost:9000/app'
...
export const currency = { symbol: '€', code: 'EUD' }
export const currencyCode = 'EUD'
export const currencySymbol = '€'
export const dimentionUnit = 'cm'
export const DOMAIN = env.PUBLIC_MEDUSAJS_API_URL // Never add any default value here, it will break SaaS working
export const entity = 'Misiki'
export const HTTP_ENDPOINT = env.PUBLIC_MEDUSAJS_API_URL
...
export const siteShortTitle = 'xxx' // used as SchemaOrg siteTitleAlt
export const siteTitle = 'yyy'
export const sorts = [
